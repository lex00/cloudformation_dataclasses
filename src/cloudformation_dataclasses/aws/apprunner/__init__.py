...
from . import observability_configuration
from . import service
from . import vpc_ingress_connection
...
class ObservabilityConfiguration(CloudFormationResource):
    ...
    trace_configuration: Optional[observability_configuration.TraceConfiguration] = None
    observability_configuration_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    tags: Optional[list[observability_configuration.Tag]] = None
...
class Service(CloudFormationResource):
    ...
    health_check_configuration: Optional[service.HealthCheckConfiguration] = None
    instance_configuration: Optional[service.InstanceConfiguration] = None
    encryption_configuration: Optional[service.EncryptionConfiguration] = None
    service_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    observability_configuration: Optional[service.ServiceObservabilityConfiguration] = None
    source_configuration: Optional[service.SourceConfiguration] = None
...
class VpcIngressConnection(CloudFormationResource):
    ...
    tags: Optional[list[vpc_ingress_connection.Tag]] = None
    ingress_vpc_configuration: Optional[vpc_ingress_connection.IngressVpcConfiguration] = None
