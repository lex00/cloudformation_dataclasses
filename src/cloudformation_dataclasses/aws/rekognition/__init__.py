...
class StreamProcessor(CloudFormationResource):
    ...
    s3_destination: Optional[stream_processor.S3Destination] = None
    data_sharing_preference: Optional[stream_processor.DataSharingPreference] = None
    kms_key_id: Optional[Union[str, Ref, GetAtt, Sub]] = None
    face_search_settings: Optional[stream_processor.FaceSearchSettings] = None
    polygon_regions_of_interest: Optional[Union[dict[str, Any], Ref, GetAtt, Sub]] = None
    role_arn: Optional[Union[str, Ref, GetAtt, Sub]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    connected_home_settings: Optional[stream_processor.ConnectedHomeSettings] = None
    notification_channel: Optional[stream_processor.NotificationChannel] = None
    kinesis_video_stream: Optional[stream_processor.KinesisVideoStream] = None
    bounding_box_regions_of_interest: Optional[list[stream_processor.BoundingBox]] = None
    kinesis_data_stream: Optional[stream_processor.KinesisDataStream] = None
    tags: Optional[list[stream_processor.Tag]] = None
