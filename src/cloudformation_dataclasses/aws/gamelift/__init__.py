...
from . import alias
from . import build
from . import container_fleet
from . import container_group_definition
from . import fleet
from . import game_server_group
from . import game_session_queue
from . import matchmaking_configuration
from . import script
...
class Alias(CloudFormationResource):
    ...
    routing_strategy: Optional[alias.RoutingStrategy] = None
    tags: Optional[list[alias.Tag]] = None
...
class Build(CloudFormationResource):
    ...
    storage_location: Optional[build.StorageLocation] = None
    tags: Optional[list[build.Tag]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class ContainerFleet(CloudFormationResource):
    ...
    scaling_policies: Optional[list[container_fleet.ScalingPolicy]] = None
    ...
    locations: Optional[list[container_fleet.LocationConfiguration]] = None
    game_session_creation_limit_policy: Optional[container_fleet.GameSessionCreationLimitPolicy] = None
    ...
    log_configuration: Optional[container_fleet.LogConfiguration] = None
    instance_connection_port_range: Optional[container_fleet.ConnectionPortRange] = None
    metric_groups: Optional[Union[list[str], Ref]] = None
    instance_inbound_permissions: Optional[list[container_fleet.IpPermission]] = None
    instance_type: Optional[Union[str, Ref, GetAtt, Sub]] = None
    tags: Optional[list[container_fleet.Tag]] = None
    deployment_configuration: Optional[container_fleet.DeploymentConfiguration] = None
...
class ContainerGroupDefinition(CloudFormationResource):
    ...
    game_server_container_definition: Optional[container_group_definition.GameServerContainerDefinition] = None
    ...
    tags: Optional[list[container_group_definition.Tag]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    container_group_type: Optional[Union[str, ContainerGroupType, Ref, GetAtt, Sub]] = None
    support_container_definitions: Optional[list[container_group_definition.SupportContainerDefinition]] = None
...
class Fleet(CloudFormationResource):
    ...
    scaling_policies: Optional[list[fleet.ScalingPolicy]] = None
    description: Optional[Union[str, Ref, GetAtt, Sub]] = None
    ...
    ec2_inbound_permissions: Optional[list[fleet.IpPermission]] = None
    locations: Optional[list[fleet.LocationConfiguration]] = None
    ...
    runtime_configuration: Optional[fleet.RuntimeConfiguration] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    peer_vpc_aws_account_id: Optional[Union[str, Ref, GetAtt, Sub]] = None
    anywhere_configuration: Optional[fleet.AnywhereConfiguration] = None
    instance_role_arn: Optional[Union[str, Ref, GetAtt, Sub]] = None
    metric_groups: Optional[Union[list[str], Ref]] = None
    build_id: Optional[Union[str, Ref, GetAtt, Sub]] = None
    resource_creation_limit_policy: Optional[fleet.ResourceCreationLimitPolicy] = None
    ec2_instance_type: Optional[Union[str, Ref, GetAtt, Sub]] = None
    certificate_configuration: Optional[fleet.CertificateConfiguration] = None
...
class GameServerGroup(CloudFormationResource):
    ...
    auto_scaling_policy: Optional[game_server_group.AutoScalingPolicy] = None
    ...
    launch_template: Optional[game_server_group.LaunchTemplate] = None
    ...
    instance_definitions: Optional[list[game_server_group.InstanceDefinition]] = None
    role_arn: Optional[Union[str, Ref, GetAtt, Sub]] = None
    tags: Optional[list[game_server_group.Tag]] = None
...
class GameSessionQueue(CloudFormationResource):
    ...
    player_latency_policies: Optional[list[game_session_queue.PlayerLatencyPolicy]] = None
    destinations: Optional[list[game_session_queue.GameSessionQueueDestination]] = None
    notification_target: Optional[Union[str, Ref, GetAtt, Sub]] = None
    filter_configuration: Optional[game_session_queue.FilterConfiguration] = None
    custom_event_data: Optional[Union[str, Ref, GetAtt, Sub]] = None
    tags: Optional[list[game_session_queue.Tag]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    priority_configuration: Optional[game_session_queue.PriorityConfiguration] = None
...
class MatchmakingConfiguration(CloudFormationResource):
    ...
    game_properties: Optional[list[matchmaking_configuration.GameProperty]] = None
    ...
    tags: Optional[list[matchmaking_configuration.Tag]] = None
...
class Script(CloudFormationResource):
    ...
    version: Optional[Union[str, Ref, GetAtt, Sub]] = None
    storage_location: Optional[script.S3Location] = None
    tags: Optional[list[script.Tag]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
