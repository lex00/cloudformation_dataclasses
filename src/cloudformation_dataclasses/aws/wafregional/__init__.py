...
from . import byte_match_set
from . import geo_match_set
from . import ip_set
from . import rate_based_rule
from . import rule
from . import size_constraint_set
from . import sql_injection_match_set
from . import web_acl
from . import xss_match_set
...
class ByteMatchSet(CloudFormationResource):
    ...
    byte_match_tuples: Optional[list[byte_match_set.ByteMatchTuple]] = None
...
class GeoMatchSet(CloudFormationResource):
    ...
    geo_match_constraints: Optional[list[geo_match_set.GeoMatchConstraint]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class IPSet(CloudFormationResource):
    ...
    ip_set_descriptors: Optional[list[ip_set.IPSetDescriptor]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class RateBasedRule(CloudFormationResource):
    ...
    match_predicates: Optional[list[rate_based_rule.Predicate]] = None
    rate_key: Optional[Union[str, RateKey, Ref, GetAtt, Sub]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class Rule(CloudFormationResource):
    ...
    metric_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    predicates: Optional[list[rule.Predicate]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class SizeConstraintSet(CloudFormationResource):
    ...
    size_constraints: Optional[list[size_constraint_set.SizeConstraint]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class SqlInjectionMatchSet(CloudFormationResource):
    ...
    sql_injection_match_tuples: Optional[list[sql_injection_match_set.SqlInjectionMatchTuple]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class WebACL(CloudFormationResource):
    ...
    metric_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    default_action: Optional[web_acl.Action] = None
...
class XssMatchSet(CloudFormationResource):
    ...
    xss_match_tuples: Optional[list[xss_match_set.XssMatchTuple]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
