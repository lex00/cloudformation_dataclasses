...
class App(CloudFormationResource):
    ...
    permission_model: Optional[app.PermissionModel] = None
    resource_mappings: Optional[list[app.ResourceMapping]] = None
    event_subscriptions: Optional[list[app.EventSubscription]] = None
...
class ResiliencyPolicy(CloudFormationResource):
    ...
    policy: Optional[resiliency_policy.PolicyMap] = None
