...
from . import cidr_collection
from . import health_check
from . import hosted_zone
from . import record_set
from . import record_set_group
...
class CidrCollection(CloudFormationResource):
    ...
    locations: Optional[list[cidr_collection.Location]] = None
...
class HealthCheck(CloudFormationResource):
    ...
    health_check_config: Optional[health_check.HealthCheckConfig] = None
    health_check_tags: Optional[list[health_check.HealthCheckTag]] = None
...
class HostedZone(CloudFormationResource):
    ...
    hosted_zone_tags: Optional[list[hosted_zone.HostedZoneTag]] = None
    vp_cs: Optional[list[hosted_zone.VPC]] = None
    hosted_zone_features: Optional[hosted_zone.HostedZoneFeatures] = None
    hosted_zone_config: Optional[hosted_zone.HostedZoneConfig] = None
    query_logging_config: Optional[hosted_zone.QueryLoggingConfig] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class RecordSet(CloudFormationResource):
    ...
    alias_target: Optional[record_set.AliasTarget] = None
    cidr_routing_config: Optional[record_set.CidrRoutingConfig] = None
    comment: Optional[Union[str, Ref, GetAtt, Sub]] = None
    failover: Optional[Union[str, Ref, GetAtt, Sub]] = None
    geo_location: Optional[record_set.GeoLocation] = None
    geo_proximity_location: Optional[record_set.GeoProximityLocation] = None
...
class RecordSetGroup(CloudFormationResource):
    ...
    hosted_zone_id: Optional[Union[str, Ref, GetAtt, Sub]] = None
    hosted_zone_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    record_sets: Optional[list[record_set_group.RecordSet]] = None
