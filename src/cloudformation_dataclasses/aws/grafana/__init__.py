...
class Workspace(CloudFormationResource):
    ...
    saml_configuration: Optional[workspace.SamlConfiguration] = None
    ...
    vpc_configuration: Optional[workspace.VpcConfiguration] = None
    network_access_control: Optional[workspace.NetworkAccessControl] = None
