...
from . import cache_cluster
from . import global_replication_group
from . import replication_group
from . import serverless_cache
from . import user
...
class CacheCluster(CloudFormationResource):
    ...
    log_delivery_configurations: Optional[list[cache_cluster.LogDeliveryConfigurationRequest]] = None
    ...
    tags: Optional[list[cache_cluster.Tag]] = None
...
class GlobalReplicationGroup(CloudFormationResource):
    ...
    regional_configurations: Optional[list[global_replication_group.RegionalConfiguration]] = None
    cache_parameter_group_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    engine: Optional[Union[str, Ref, GetAtt, Sub]] = None
    members: Optional[list[global_replication_group.GlobalReplicationGroupMember]] = None
...
class ReplicationGroup(CloudFormationResource):
    ...
    log_delivery_configurations: Optional[list[replication_group.LogDeliveryConfigurationRequest]] = None
    multi_az_enabled: Optional[Union[bool, Ref, GetAtt, Sub]] = None
    network_type: Optional[Union[str, NetworkType, Ref, GetAtt, Sub]] = None
    node_group_configuration: Optional[list[replication_group.NodeGroupConfiguration]] = None
    notification_topic_arn: Optional[Union[str, Ref, GetAtt, Sub]] = None
    ...
    tags: Optional[list[replication_group.Tag]] = None
    transit_encryption_enabled: Optional[Union[bool, Ref, GetAtt, Sub]] = None
...
class ServerlessCache(CloudFormationResource):
    ...
    cache_usage_limits: Optional[serverless_cache.CacheUsageLimits] = None
    security_group_ids: Optional[Union[list[str], Ref]] = None
    ...
    reader_endpoint: Optional[serverless_cache.Endpoint] = None
    snapshot_retention_limit: Optional[Union[int, Ref, GetAtt, Sub]] = None
    endpoint: Optional[serverless_cache.Endpoint] = None
    serverless_cache_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    major_engine_version: Optional[Union[str, Ref, GetAtt, Sub]] = None
    engine: Optional[Union[str, Ref, GetAtt, Sub]] = None
    tags: Optional[list[serverless_cache.Tag]] = None
...
class User(CloudFormationResource):
    ...
    authentication_mode: Optional[user.AuthenticationMode] = None
