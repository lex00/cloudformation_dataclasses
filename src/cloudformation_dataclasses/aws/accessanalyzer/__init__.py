...
class Analyzer(CloudFormationResource):
    ...
    archive_rules: Optional[list[analyzer.ArchiveRule]] = None
    type_: Optional[Union[str, Ref, GetAtt, Sub]] = None
    analyzer_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    tags: Optional[list[analyzer.Tag]] = None
    analyzer_configuration: Optional[analyzer.AnalyzerConfiguration] = None
