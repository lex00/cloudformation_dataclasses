...
class ProfilingGroup(CloudFormationResource):
    ...
    name_field: ClassVar[str] = "profiling_group_name"
    ...
    anomaly_detection_notification_configuration: Optional[list[profiling_group.Channel]] = None
    agent_permissions: Optional[profiling_group.AgentPermissions] = None
    compute_platform: Optional[Union[str, Ref, GetAtt, Sub]] = None
    profiling_group_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    tags: Optional[list[profiling_group.Tag]] = None
