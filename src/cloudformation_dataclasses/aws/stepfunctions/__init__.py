...
from . import state_machine_alias
...
class Activity(CloudFormationResource):
    ...
    encryption_configuration: Optional[activity.EncryptionConfiguration] = None
    tags: Optional[list[activity.TagsEntry]] = None
...
class StateMachine(CloudFormationResource):
    ...
    encryption_configuration: Optional[state_machine.EncryptionConfiguration] = None
    definition_string: Optional[Union[str, Ref, GetAtt, Sub]] = None
    logging_configuration: Optional[state_machine.LoggingConfiguration] = None
    definition_substitutions: Optional[dict[str, dict[str, Any]]] = None
    definition: Optional[Union[dict[str, Any], Ref, GetAtt, Sub]] = None
    definition_s3_location: Optional[state_machine.S3Location] = None
    state_machine_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    role_arn: Optional[Union[str, Ref, GetAtt, Sub]] = None
    tags: Optional[list[state_machine.TagsEntry]] = None
    state_machine_type: Optional[Union[str, Ref, GetAtt, Sub]] = None
    tracing_configuration: Optional[state_machine.TracingConfiguration] = None
...
class StateMachineAlias(CloudFormationResource):
    ...
    routing_configuration: Optional[list[state_machine_alias.RoutingConfigurationVersion]] = None
    deployment_preference: Optional[state_machine_alias.DeploymentPreference] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
