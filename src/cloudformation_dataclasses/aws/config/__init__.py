...
from . import config_rule
from . import configuration_aggregator
from . import configuration_recorder
from . import conformance_pack
from . import delivery_channel
from . import organization_config_rule
from . import organization_conformance_pack
from . import remediation_configuration
...
class ConfigRule(CloudFormationResource):
    ...
    evaluation_modes: Optional[list[config_rule.EvaluationModeConfiguration]] = None
    description: Optional[Union[str, Ref, GetAtt, Sub]] = None
    scope: Optional[config_rule.Scope] = None
    compliance: Optional[config_rule.Compliance] = None
    ...
    source: Optional[config_rule.Source] = None
...
class ConfigurationAggregator(CloudFormationResource):
    ...
    account_aggregation_sources: Optional[list[configuration_aggregator.AccountAggregationSource]] = None
    configuration_aggregator_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    organization_aggregation_source: Optional[configuration_aggregator.OrganizationAggregationSource] = None
    tags: Optional[list[configuration_aggregator.Tag]] = None
...
class ConfigurationRecorder(CloudFormationResource):
    ...
    recording_group: Optional[configuration_recorder.RecordingGroup] = None
    recording_mode: Optional[configuration_recorder.RecordingMode] = None
...
class ConformancePack(CloudFormationResource):
    ...
    conformance_pack_input_parameters: Optional[list[conformance_pack.ConformancePackInputParameter]] = None
    template_ssm_document_details: Optional[conformance_pack.TemplateSSMDocumentDetails] = None
...
class DeliveryChannel(CloudFormationResource):
    ...
    config_snapshot_delivery_properties: Optional[delivery_channel.ConfigSnapshotDeliveryProperties] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class OrganizationConfigRule(CloudFormationResource):
    ...
    organization_managed_rule_metadata: Optional[organization_config_rule.OrganizationManagedRuleMetadata] = None
    organization_config_rule_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    organization_custom_rule_metadata: Optional[organization_config_rule.OrganizationCustomRuleMetadata] = None
    excluded_accounts: Optional[Union[list[str], Ref]] = None
    organization_custom_policy_rule_metadata: Optional[organization_config_rule.OrganizationCustomPolicyRuleMetadata] = None
...
class OrganizationConformancePack(CloudFormationResource):
    ...
    conformance_pack_input_parameters: Optional[list[organization_conformance_pack.ConformancePackInputParameter]] = None
    delivery_s3_bucket: Optional[Union[str, Ref, GetAtt, Sub]] = None
    excluded_accounts: Optional[Union[list[str], Ref]] = None
    delivery_s3_key_prefix: Optional[Union[str, Ref, GetAtt, Sub]] = None
    template_body: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class RemediationConfiguration(CloudFormationResource):
    ...
    execution_controls: Optional[remediation_configuration.ExecutionControls] = None
