...
class Application(CloudFormationResource):
    ...
    definition: Optional[application.Definition] = None
...
class Environment(CloudFormationResource):
    ...
    kms_key_id: Optional[Union[str, Ref, GetAtt, Sub]] = None
    high_availability_config: Optional[environment.HighAvailabilityConfig] = None
    ...
    storage_configurations: Optional[list[environment.StorageConfiguration]] = None
    tags: Optional[dict[str, str]] = None
