...
from . import hook_version
from . import lambda_hook
from . import resource_version
from . import stack_set
from . import type_activation
...
class GuardHook(CloudFormationResource):
    ...
    options: Optional[guard_hook.Options] = None
    rule_location: Optional[guard_hook.S3Location] = None
    hook_status: Optional[Union[str, Ref, GetAtt, Sub]] = None
    alias: Optional[Union[str, Ref, GetAtt, Sub]] = None
    stack_filters: Optional[guard_hook.StackFilters] = None
    target_operations: Optional[Union[list[str], Ref]] = None
    target_filters: Optional[guard_hook.TargetFilters] = None
...
class HookVersion(CloudFormationResource):
    ...
    type_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    logging_config: Optional[hook_version.LoggingConfig] = None
...
class LambdaHook(CloudFormationResource):
    ...
    hook_status: Optional[Union[str, Ref, GetAtt, Sub]] = None
    alias: Optional[Union[str, Ref, GetAtt, Sub]] = None
    stack_filters: Optional[lambda_hook.StackFilters] = None
    target_operations: Optional[Union[list[str], Ref]] = None
    target_filters: Optional[lambda_hook.TargetFilters] = None
...
class ResourceVersion(CloudFormationResource):
    ...
    execution_role_arn: Optional[Union[str, Ref, GetAtt, Sub]] = None
    type_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    logging_config: Optional[resource_version.LoggingConfig] = None
    schema_handler_package: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class StackSet(CloudFormationResource):
    ...
    description: Optional[Union[str, Ref, GetAtt, Sub]] = None
    parameters: Optional[list[stack_set.Parameter]] = None
    stack_instances_group: Optional[list[stack_set.StackInstances]] = None
    ...
    operation_preferences: Optional[stack_set.OperationPreferences] = None
    template_url: Optional[Union[str, Ref, GetAtt, Sub]] = None
    auto_deployment: Optional[stack_set.AutoDeployment] = None
    ...
    managed_execution: Optional[stack_set.ManagedExecution] = None
    tags: Optional[list[stack_set.Tag]] = None
...
class TypeActivation(CloudFormationResource):
    ...
    logging_config: Optional[type_activation.LoggingConfig] = None
