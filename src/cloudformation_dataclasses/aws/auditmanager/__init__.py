...
class Assessment(CloudFormationResource):
    ...
    assessment_reports_destination: Optional[assessment.AssessmentReportsDestination] = None
    delegations: Optional[list[assessment.Delegation]] = None
    description: Optional[Union[str, Ref, GetAtt, Sub]] = None
    scope: Optional[assessment.Scope] = None
    aws_account: Optional[assessment.AWSAccount] = None
    roles: Optional[list[assessment.Role]] = None
    framework_id: Optional[Union[str, Ref, GetAtt, Sub]] = None
    tags: Optional[list[assessment.Tag]] = None
