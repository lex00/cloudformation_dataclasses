...
class Detector(CloudFormationResource):
    ...
    event_type: Optional[detector.EventType] = None
    detector_id: Optional[Union[str, Ref, GetAtt, Sub]] = None
    associated_models: Optional[list[detector.Model]] = None
    rule_execution_mode: Optional[Union[str, Ref, GetAtt, Sub]] = None
    rules: Optional[list[detector.Rule]] = None
    tags: Optional[list[detector.Tag]] = None
...
class EventType(CloudFormationResource):
    ...
    entity_types: Optional[list[event_type.EntityType]] = None
    description: Optional[Union[str, Ref, GetAtt, Sub]] = None
    labels: Optional[list[event_type.Label]] = None
    event_variables: Optional[list[event_type.EventVariable]] = None
    tags: Optional[list[event_type.Tag]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
