...
from . import cross_account_attachment
from . import endpoint_group
...
class CrossAccountAttachment(CloudFormationResource):
    ...
    resources: Optional[list[cross_account_attachment.Resource]] = None
    tags: Optional[list[cross_account_attachment.Tag]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class EndpointGroup(CloudFormationResource):
    ...
    port_overrides: Optional[list[endpoint_group.PortOverride]] = None
    ...
    endpoint_configurations: Optional[list[endpoint_group.EndpointConfiguration]] = None
...
class Listener(CloudFormationResource):
    ...
    port_ranges: Optional[list[listener.PortRange]] = None
