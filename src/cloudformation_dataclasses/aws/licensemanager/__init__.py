...
class License(CloudFormationResource):
    ...
    consumption_configuration: Optional[license.ConsumptionConfiguration] = None
    validity: Optional[license.ValidityDateFormat] = None
    product_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    issuer: Optional[license.IssuerData] = None
    home_region: Optional[Union[str, Ref, GetAtt, Sub]] = None
    entitlements: Optional[list[license.Entitlement]] = None
    license_metadata: Optional[list[license.Metadata]] = None
