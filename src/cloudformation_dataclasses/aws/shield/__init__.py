...
from . import proactive_engagement
...
class ProactiveEngagement(CloudFormationResource):
    ...
    emergency_contact_list: Optional[list[proactive_engagement.EmergencyContact]] = None
...
class Protection(CloudFormationResource):
    ...
    application_layer_automatic_response_configuration: Optional[protection.ApplicationLayerAutomaticResponseConfiguration] = None
    tags: Optional[list[protection.Tag]] = None
