...
from . import firewall_rule_group
from . import resolver_endpoint
from . import resolver_rule
...
class FirewallRuleGroup(CloudFormationResource):
    ...
    firewall_rules: Optional[list[firewall_rule_group.FirewallRule]] = None
    tags: Optional[list[firewall_rule_group.Tag]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class ResolverEndpoint(CloudFormationResource):
    ...
    ip_addresses: Optional[list[resolver_endpoint.IpAddressRequest]] = None
    ...
    tags: Optional[list[resolver_endpoint.Tag]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
...
class ResolverRule(CloudFormationResource):
    ...
    tags: Optional[list[resolver_rule.Tag]] = None
    target_ips: Optional[list[resolver_rule.TargetAddress]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
