...
from . import anomaly_monitor
from . import anomaly_subscription
from . import cost_category
...
class AnomalyMonitor(CloudFormationResource):
    ...
    resource_tags: Optional[list[anomaly_monitor.ResourceTag]] = None
...
class AnomalySubscription(CloudFormationResource):
    ...
    resource_tags: Optional[list[anomaly_subscription.ResourceTag]] = None
    ...
    subscribers: Optional[list[anomaly_subscription.Subscriber]] = None
...
class CostCategory(CloudFormationResource):
    ...
    tags: Optional[list[cost_category.ResourceTag]] = None
