...
class DocumentClassifier(CloudFormationResource):
    ...
    output_data_config: Optional[document_classifier.DocumentClassifierOutputDataConfig] = None
    vpc_config: Optional[document_classifier.VpcConfig] = None
    ...
    input_data_config: Optional[document_classifier.DocumentClassifierInputDataConfig] = None
    tags: Optional[list[document_classifier.Tag]] = None
...
class Flywheel(CloudFormationResource):
    ...
    task_config: Optional[flywheel.TaskConfig] = None
    active_model_arn: Optional[Union[str, Ref, GetAtt, Sub]] = None
    data_security_config: Optional[flywheel.DataSecurityConfig] = None
    tags: Optional[list[flywheel.Tag]] = None
