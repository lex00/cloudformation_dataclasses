...
class Member(CloudFormationResource):
    ...
    member_configuration: Optional[member.MemberConfiguration] = None
    network_configuration: Optional[member.NetworkConfiguration] = None
...
class Node(CloudFormationResource):
    ...
    network_id: Optional[Union[str, Ref, GetAtt, Sub]] = None
    node_configuration: Optional[node.NodeConfiguration] = None
