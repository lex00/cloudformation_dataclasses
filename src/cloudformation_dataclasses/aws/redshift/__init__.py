...
from . import cluster
from . import cluster_parameter_group
from . import endpoint_access
...
class Cluster(CloudFormationResource):
    ...
    endpoint: Optional[cluster.Endpoint] = None
    ...
    logging_properties: Optional[cluster.LoggingProperties] = None
...
class ScheduledAction(CloudFormationResource):
    ...
    target_action: Optional[scheduled_action.ScheduledActionType] = None
