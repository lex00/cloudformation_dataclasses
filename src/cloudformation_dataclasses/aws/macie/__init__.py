...
from . import allow_list
from . import findings_filter
...
class AllowList(CloudFormationResource):
    ...
    criteria: Optional[allow_list.Criteria] = None
    tags: Optional[list[allow_list.Tag]] = None
...
class FindingsFilter(CloudFormationResource):
    ...
    finding_criteria: Optional[findings_filter.FindingCriteria] = None
    tags: Optional[list[findings_filter.Tag]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
