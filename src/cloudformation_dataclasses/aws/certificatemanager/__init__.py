...
class Account(CloudFormationResource):
    ...
    expiry_events_configuration: Optional[account.ExpiryEventsConfiguration] = None
...
class Certificate(CloudFormationResource):
    ...
    domain_validation_options: Optional[list[certificate.DomainValidationOption]] = None
    key_algorithm: Optional[Union[str, Ref, GetAtt, Sub]] = None
    subject_alternative_names: Optional[Union[list[str], Ref]] = None
    tags: Optional[list[certificate.Tag]] = None
