"""
AWS CloudFormation WAFRegional Resources
...
class GeoMatchSet(CloudFormationResource):
    ...
    # http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-reso
    geo_match_constraints: Optional[list[GeoMatchConstraint]] = None
    # http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-reso
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    ...
    def _get_properties(self) -> dict[str, Any]:
        ...
        if self.geo_match_constraints is not None:
            # Serialize geo_match_constraints (handle intrinsic functions)
            if hasattr(self.geo_match_constraints, 'to_dict'):
                props["GeoMatchConstraints"] = self.geo_match_constraints.to_dict()
            elif isinstance(self.geo_match_constraints, list):
                # Serialize list items (may contain intrinsic functions)
                props['GeoMatchConstraints'] = [
                    item.to_dict() if hasattr(item, 'to_dict') else item
                    for item in self.geo_match_constraints
                ]
            else:
                props["GeoMatchConstraints"] = self.geo_match_constraints
...
class RateBasedRule(CloudFormationResource):
    ...
    # http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-reso
    match_predicates: Optional[list[Predicate]] = None
    # http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-reso
    rate_key: Optional[Union[str, Ref, GetAtt, Sub]] = None
    # http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-reso
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    ...
    def _get_properties(self) -> dict[str, Any]:
        ...
        if self.rate_limit is not None:
            # Serialize rate_limit (handle intrinsic functions)
        ...
        if self.match_predicates is not None:
            # Serialize match_predicates (handle intrinsic functions)
            if hasattr(self.match_predicates, 'to_dict'):
                props["MatchPredicates"] = self.match_predicates.to_dict()
            elif isinstance(self.match_predicates, list):
                # Serialize list items (may contain intrinsic functions)
                props['MatchPredicates'] = [
                    item.to_dict() if hasattr(item, 'to_dict') else item
                    for item in self.match_predicates
                ]
            else:
                props["MatchPredicates"] = self.match_predicates

        if self.rate_key is not None:
            # Serialize rate_key (handle intrinsic functions)
            if hasattr(self.rate_key, 'to_dict'):
                props["RateKey"] = self.rate_key.to_dict()
            elif isinstance(self.rate_key, list):
                # Serialize list items (may contain intrinsic functions)
                props['RateKey'] = [
                    item.to_dict() if hasattr(item, 'to_dict') else item
                    for item in self.rate_key
                ]
            else:
                props["RateKey"] = self.rate_key
...
class RegexPatternSet(CloudFormationResource):
    ...
    # http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-reso
    regex_pattern_strings: Optional[Union[list[str], Ref]] = None
    # http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-reso
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    ...
    def _get_properties(self) -> dict[str, Any]:
        ...
        if self.regex_pattern_strings is not None:
            # Serialize regex_pattern_strings (handle intrinsic functions)
            if hasattr(self.regex_pattern_strings, 'to_dict'):
                props["RegexPatternStrings"] = self.regex_pattern_strings.to_dict()
            elif isinstance(self.regex_pattern_strings, list):
                # Serialize list items (may contain intrinsic functions)
                props['RegexPatternStrings'] = [
                    item.to_dict() if hasattr(item, 'to_dict') else item
                    for item in self.regex_pattern_strings
                ]
            else:
                props["RegexPatternStrings"] = self.regex_pattern_strings
...
class WebACLAssociation(CloudFormationResource):
    ...
    def _get_properties(self) -> dict[str, Any]:
        ...
        if self.web_acl_id is not None:
            # Serialize web_acl_id (handle intrinsic functions)
