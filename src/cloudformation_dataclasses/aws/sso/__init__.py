...
from . import instance_access_control_attribute_configuration
...
class Application(CloudFormationResource):
    ...
    portal_options: Optional[application.PortalOptionsConfiguration] = None
...
class InstanceAccessControlAttributeConfiguration(CloudFormationResource):
    ...
    instance_arn: Optional[Union[str, Ref, GetAtt, Sub]] = None
    access_control_attributes: Optional[list[instance_access_control_attribute_configuration.AccessControlAttribute]] = None
...
class PermissionSet(CloudFormationResource):
    ...
    customer_managed_policy_references: Optional[list[permission_set.CustomerManagedPolicyReference]] = None
    ...
    tags: Optional[list[permission_set.Tag]] = None
    name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    permissions_boundary: Optional[permission_set.PermissionsBoundary] = None
