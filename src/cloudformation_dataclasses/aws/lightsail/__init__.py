...
from . import disk
from . import disk_snapshot
from . import distribution
from . import domain
from . import instance
from . import instance_snapshot
...
class Bucket(CloudFormationResource):
    ...
    access_rules: Optional[bucket.AccessRules] = None
...
class Container(CloudFormationResource):
    ...
    public_domain_names: Optional[list[container.PublicDomainName]] = None
    service_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    private_registry_access: Optional[container.PrivateRegistryAccess] = None
    container_service_deployment: Optional[container.ContainerServiceDeployment] = None
...
class Database(CloudFormationResource):
    ...
    relational_database_parameters: Optional[list[database.RelationalDatabaseParameter]] = None
    ...
    tags: Optional[list[database.Tag]] = None
...
class Disk(CloudFormationResource):
    ...
    availability_zone: Optional[Union[str, Ref, GetAtt, Sub]] = None
    add_ons: Optional[list[disk.AddOn]] = None
    disk_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    tags: Optional[list[disk.Tag]] = None
    location: Optional[disk.Location] = None
...
class DiskSnapshot(CloudFormationResource):
    ...
    disk_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    tags: Optional[list[disk_snapshot.Tag]] = None
...
class Distribution(CloudFormationResource):
    ...
    origin: Optional[distribution.InputOrigin] = None
    distribution_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    bundle_id: Optional[Union[str, Ref, GetAtt, Sub]] = None
    default_cache_behavior: Optional[distribution.CacheBehavior] = None
    is_enabled: Optional[Union[bool, Ref, GetAtt, Sub]] = None
    cache_behavior_settings: Optional[distribution.CacheSettings] = None
    certificate_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    tags: Optional[list[distribution.Tag]] = None
    cache_behaviors: Optional[list[distribution.CacheBehaviorPerPath]] = None
...
class Domain(CloudFormationResource):
    ...
    domain_name: Optional[Union[str, Ref, GetAtt, Sub]] = None
    domain_entries: Optional[list[domain.DomainEntry]] = None
...
class Instance(CloudFormationResource):
    ...
    networking: Optional[instance.Networking] = None
    user_data: Optional[Union[str, Ref, GetAtt, Sub]] = None
    state: Optional[instance.State] = None
    availability_zone: Optional[Union[str, Ref, GetAtt, Sub]] = None
    add_ons: Optional[list[instance.AddOn]] = None
    hardware: Optional[instance.Hardware] = None
    tags: Optional[list[instance.Tag]] = None
    location: Optional[instance.Location] = None
...
class InstanceSnapshot(CloudFormationResource):
    ...
    tags: Optional[list[instance_snapshot.Tag]] = None
