...
from . import application_instance
from . import package
...
class ApplicationInstance(CloudFormationResource):
    ...
    manifest_overrides_payload: Optional[application_instance.ManifestOverridesPayload] = None
    runtime_role_arn: Optional[Union[str, Ref, GetAtt, Sub]] = None
    manifest_payload: Optional[application_instance.ManifestPayload] = None
    tags: Optional[list[application_instance.Tag]] = None
...
class Package(CloudFormationResource):
    ...
    storage_location: Optional[package.StorageLocation] = None
    tags: Optional[list[package.Tag]] = None
