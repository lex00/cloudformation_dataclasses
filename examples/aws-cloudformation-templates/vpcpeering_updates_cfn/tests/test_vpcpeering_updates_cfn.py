"""Tests for vpcpeering_updates_cfn example."""

import pytest

from vpcpeering_updates_cfn.main import build_template


class TestVpcpeeringUpdatesCfn:
    """Test vpcpeering_updates_cfn example."""
