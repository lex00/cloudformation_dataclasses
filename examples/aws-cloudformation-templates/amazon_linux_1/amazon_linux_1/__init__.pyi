...
__all__: list[str] = ['Base64', 'EC2Instance', 'IAMRole', 'InstanceAMI', 'InstanceSecurityGroup', 'InstanceSecurityGroupEgress', 'InstanceType', 'KeyName', 'Parameter', 'ParameterType', 'SSHLocation', 'STRING', 'Sub', 'SubnetId', 'Template', 'cloudformation_dataclass', 'ec2', 'get_att', 'ref', 'setup_resources']
