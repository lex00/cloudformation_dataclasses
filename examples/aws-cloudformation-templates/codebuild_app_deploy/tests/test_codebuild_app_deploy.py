"""Tests for codebuild_app_deploy example."""

import pytest

from codebuild_app_deploy.main import build_template


class TestCodebuildAppDeploy:
    """Test codebuild_app_deploy example."""
