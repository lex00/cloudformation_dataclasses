...
Migrated from [AutoScalingScheduledAction.yaml](https://github.com/aws-cloudformation/cfn-lint).
...
```bash
python -m autoscalingscheduledaction
```

### Validate Template

```bash
python -m autoscalingscheduledaction --validate
```
