...
Migrated from [cfn-endpoint-creationpolicy.yaml](https://github.com/aws-cloudformation/aws-cloudformation-templates).
...
```bash
uv run python -m cfn_endpoint_creationpolicy
```
