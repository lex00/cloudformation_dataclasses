...
Migrated from [log-setup-management-pkg.json](https://github.com/aws-cloudformation/cfn-lint).
...
```bash
python -m log_setup_management_pkg
```

### Validate Template

```bash
python -m log_setup_management_pkg --validate
```
