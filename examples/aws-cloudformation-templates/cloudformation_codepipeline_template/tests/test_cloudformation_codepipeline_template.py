...
from cloudformation_codepipeline_template.main import build_template


class TestCloudformationCodepipelineTemplate:
    """Test cloudformation_codepipeline_template example."""
