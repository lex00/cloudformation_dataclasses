...
```bash
# Generate template
python -m emrclustergangliawithsparkors3backedhbase.main

# Type check
mypy emrclustergangliawithsparkors3backedhbase/

# Run tests
pytest emrclustergangliawithsparkors3backedhbase/tests/
```
