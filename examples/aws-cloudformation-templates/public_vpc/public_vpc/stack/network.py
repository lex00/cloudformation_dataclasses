"""Network resources: VPC, PublicSubnetOne, PublicSubnetTwo, InternetGateway, GatewayAttachement, PublicRouteTable, PublicRoute, PublicSubnetOneRouteTableAssociation, PublicSubnetTwoRouteTableAssociation, FargateContainerSecurityGroup, PublicLoadBalancerSG, PublicLoadBalancer, DummyTargetGroupPublic, PublicLoadBalancerListener."""
