...
__all__: list[str] = ['AWSInstanceType2ArchMapping', 'AWSRegionArch2AMIMapping', 'AWS_REGION', 'AutoScalingGroup', 'Base64', 'ElasticLoadBalancer', 'ElasticLoadBalancerHealthCheck', 'ElasticLoadBalancerListeners', 'FindInMap', 'GetAZs', 'InstanceSecurityGroup', 'InstanceSecurityGroupEgress', 'InstanceSecurityGroupEgress1', 'InstanceType', 'Join', 'KeyName', 'LaunchTemplate', 'LaunchTemplateSpotFleetLaunchSpecification', 'Mapping', 'Output', 'Parameter', 'ParameterType', 'Region2ExamplesMapping', 'SSHLocation', 'STRING', 'ScheduledActionDown', 'ScheduledActionUp', 'Sub', 'Template', 'URLOutput', 'WebServerGroup', 'WebServerGroupLaunchTemplateSpecification', 'autoscaling', 'cloudformation_dataclass', 'ec2', 'elasticloadbalancing', 'get_att', 'ref', 'setup_resources']
