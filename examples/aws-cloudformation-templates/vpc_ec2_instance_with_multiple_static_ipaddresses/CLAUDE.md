...
```bash
# Generate template
python -m vpc_ec2_instance_with_multiple_static_ipaddresses.main

# Type check
mypy vpc_ec2_instance_with_multiple_static_ipaddresses/

# Run tests
pytest vpc_ec2_instance_with_multiple_static_ipaddresses/tests/
```
