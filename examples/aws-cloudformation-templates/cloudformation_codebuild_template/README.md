...
Migrated from [cloudformation-codebuild-template.yaml](https://github.com/aws-cloudformation/aws-cloudformation-templates).
...
```bash
uv run python -m cloudformation_codebuild_template
```
