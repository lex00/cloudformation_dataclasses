...
__all__: list[str] = ['AWS_REGION', 'Base64', 'EC2Instance', 'FindInMap', 'IAMRole', 'InstanceSecurityGroup', 'InstanceSecurityGroupEgress', 'InstanceType', 'KeyName', 'Mapping', 'Parameter', 'ParameterType', 'RegionMapMapping', 'SSHLocation', 'STRING', 'SUSEVersion', 'Sub', 'SubnetId', 'Template', 'cloudformation_dataclass', 'ec2', 'get_att', 'ref', 'setup_resources']
