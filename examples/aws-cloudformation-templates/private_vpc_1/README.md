...
Migrated from [private-vpc_1.yaml](https://github.com/aws-cloudformation/cfn-lint).
...
```bash
python -m private_vpc_1
```

### Validate Template

```bash
python -m private_vpc_1 --validate
```
...
| `ContainerInstances` | AWS::EC2::LaunchTemplate |
