...
__all__: list[str] = ['Base64', 'EC2Instance', 'IAMRole', 'InstanceAMI', 'InstanceType', 'KeyName', 'Parameter', 'ParameterType', 'SSMKey', 'STRING', 'Sub', 'SubnetId', 'Template', 'cloudformation_dataclass', 'ec2', 'get_att', 'ref', 'setup_resources']
