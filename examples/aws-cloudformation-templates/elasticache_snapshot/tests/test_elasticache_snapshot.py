"""Tests for elasticache_snapshot example."""

import pytest

from elasticache_snapshot.main import build_template


class TestElasticacheSnapshot:
    """Test elasticache_snapshot example."""
