...
Migrated from [DMSAuroraToS3FullLoadAndOngoingReplication.yaml](https://github.com/aws-cloudformation/cfn-lint).
...
```bash
python -m dmsauroratos3fullloadandongoingreplication
```

### Validate Template

```bash
python -m dmsauroratos3fullloadandongoingreplication --validate
```
