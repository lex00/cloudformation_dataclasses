...
__all__: list[str] = ['AWS_REGION', 'Base64', 'EC2Instance', 'FindInMap', 'IAMRole', 'InstanceSecurityGroup', 'InstanceSecurityGroupEgress', 'InstanceType', 'KeyName', 'Mapping', 'Parameter', 'ParameterType', 'RHELVersion', 'RegionMapMapping', 'SSHLocation', 'STRING', 'Sub', 'SubnetId', 'Template', 'cloudformation_dataclass', 'ec2', 'get_att', 'ref', 'setup_resources']
