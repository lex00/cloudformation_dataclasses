"""Tests for amzn2_greengrass_cfn example."""

import pytest

from amzn2_greengrass_cfn.main import build_template


class TestAmzn2GreengrassCfn:
    """Test amzn2_greengrass_cfn example."""
