...
@cloudformation_dataclass
class AWSManagedADDomainMembersSGEgress1:
    resource: ec2.security_group.Egress
    ip_protocol = '-1'
    description = 'LAB - Allow All Private IP Communications'
...
@cloudformation_dataclass
class AWSManagedADDomainMembersSGEgress2:
    resource: ec2.security_group.Egress
    ip_protocol = '-1'
    description = 'LAB - Allow All Private IP Communications'
...
@cloudformation_dataclass
class AWSManagedADDomainMembersSGEgress3:
    resource: ec2.security_group.Egress
...
class AWSManagedADDomainMembersSG:
    ...
    vpc_id = ref(VPCID)
    security_group_ingress = [AWSManagedADDomainMembersSGEgress, AWSManagedADDomainMembersSGEgress1, AWSManagedADDomainMembersSGEgress2]
    security_group_egress = [AWSManagedADDomainMembersSGEgress3]
