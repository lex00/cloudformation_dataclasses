"""Network resources: VPC, PublicSubnetOne, PublicSubnetTwo, PrivateSubnetOne, PrivateSubnetTwo, InternetGateway, GatewayAttachement, PublicRouteTable, PublicRoute, PublicSubnetOneRouteTableAssociation, PublicSubnetTwoRouteTableAssociation, NatGatewayOneAttachment, NatGatewayTwoAttachment, NatGatewayOne, NatGatewayTwo, PrivateRouteTableOne, PrivateRouteOne, PrivateRouteTableOneAssociation, PrivateRouteTableTwo, PrivateRouteTwo, PrivateRouteTableTwoAssociation, DynamoDBEndpoint, FargateContainerSecurityGroup, PublicLoadBalancerSG, PrivateLoadBalancerSG, PublicLoadBalancer, DummyTargetGroupPublic, PublicLoadBalancerListener, PrivateLoadBalancer, DummyTargetGroupPrivate, PrivateLoadBalancerListener."""
