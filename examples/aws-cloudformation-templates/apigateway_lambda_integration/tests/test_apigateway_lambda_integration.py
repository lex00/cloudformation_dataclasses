"""Tests for apigateway_lambda_integration example."""

import pytest

from apigateway_lambda_integration.main import build_template


class TestApigatewayLambdaIntegration:
    """Test apigateway_lambda_integration example."""
