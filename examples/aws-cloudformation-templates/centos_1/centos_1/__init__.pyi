...
__all__: list[str] = ['AWS_REGION', 'Base64', 'CentOSVersion', 'EC2Instance', 'FindInMap', 'IAMRole', 'InstanceSecurityGroup', 'InstanceSecurityGroupEgress', 'InstanceType', 'KeyName', 'Mapping', 'Parameter', 'ParameterType', 'RegionMapMapping', 'SSHLocation', 'STRING', 'Sub', 'SubnetId', 'Template', 'cloudformation_dataclass', 'ec2', 'get_att', 'ref', 'setup_resources']
