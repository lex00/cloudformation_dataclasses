...
from cfn_endpoint_waitcondition.main import build_template


class TestCfnEndpointWaitcondition:
    """Test cfn_endpoint_waitcondition example."""
    ...
    def test_resource_count(self, template):
        ...
        assert len(output["Resources"]) == 27
