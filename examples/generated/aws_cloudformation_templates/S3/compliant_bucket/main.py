...
"""
    parameters = [AppName]
    resources = [ObjectStorageBucket, ObjectStorageBucketPolicyPolicy, ObjectStorageLogBucket, ObjectStorageLogBucketPolicyPolicy, ObjectStorageReplicaBucket, ObjectStorageReplicaBucketPolicyPolicy, ObjectStorageReplicationPolicy, ObjectStorageReplicationRole]



def build_template() -> Template:
    """Build the CloudFormation template."""
    return CompliantBucketTemplate().resource
