...
Migrated from [cfn-endpoint-creationpolicy-no-igw.yaml](https://github.com/aws-cloudformation/aws-cloudformation-templates).
...
```bash
uv run python -m cfn_endpoint_creationpolicy_no_igw
```
