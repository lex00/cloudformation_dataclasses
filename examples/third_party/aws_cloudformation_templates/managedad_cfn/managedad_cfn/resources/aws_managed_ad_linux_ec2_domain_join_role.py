...
class AWSManagedADLinuxEC2DomainJoinRoleAllowStatement0:
...
@cloudformation_dataclass
class AWSManagedADLinuxEC2DomainJoinRoleAssumeRolePolicyDocument:
    resource: PolicyDocument
    statement = [AWSManagedADLinuxEC2DomainJoinRoleAllowStatement0]


@cloudformation_dataclass
class AWSManagedADLinuxEC2DomainJoinRoleAllowStatement0_1:
    resource: PolicyStatement
    action = 's3:GetObject'
    resource_arn = [
...
@cloudformation_dataclass
class AWSManagedADLinuxEC2DomainJoinRolePolicies0PolicyDocument:
    resource: PolicyDocument
    statement = [AWSManagedADLinuxEC2DomainJoinRoleAllowStatement0_1]
...
@cloudformation_dataclass
class AWSManagedADLinuxEC2DomainJoinRoleAllowStatement0_2:
    resource: PolicyStatement
    action = [
        'secretsmanager:GetSecretValue',
        'secretsmanager:DescribeSecret',
    ]
    resource_arn = ref(AWSManagedADLinuxEC2SeamlessDomainJoinSecret)


@cloudformation_dataclass
class AWSManagedADLinuxEC2DomainJoinRolePolicies2PolicyDocument:
    resource: PolicyDocument
    statement = [AWSManagedADLinuxEC2DomainJoinRoleAllowStatement0_2]
...
class AWSManagedADLinuxEC2DomainJoinRole:
    ...
    policies = [AWSManagedADLinuxEC2DomainJoinRolePolicy, If("SSMLogsBucketNameCondition", {
...
}, AWS_NO_VALUE), AWSManagedADLinuxEC2DomainJoinRolePolicy1, If("SecretsManagerDomainCredentialsSecretsKMSKeyCondition", {
