...
Migrated from [ELBWithLockedDownAutoScaledInstances.yaml](https://github.com/aws-cloudformation/aws-cloudformation-templates).
...
```bash
uv run python -m elbwithlockeddownautoscaledinstances
```
